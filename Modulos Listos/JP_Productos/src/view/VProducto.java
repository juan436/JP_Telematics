...
public class VProducto extends JFrame implements ActionListener, IProducto {
	...
	public VProducto() {
		...
		crear.setCursor(new Cursor(HAND_CURSOR));
		...
		modificar.setCursor(new Cursor(HAND_CURSOR));
	...
	public void salir() {
		// TODO Auto-generated method stub
		if (JOptionPane.showConfirmDialog(null, "¿Realmente desea salir de la ventana de PRODUCTOS?", "SALIDA DEL SISTEMA", JOptionPane.YES_NO_OPTION,
